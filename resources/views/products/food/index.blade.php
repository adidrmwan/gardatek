    ...
    <div class="container">
        <div class="row no-gutters text align-items-end justify-content-center" data-scrollax-parent="true">
            <div class="col-md-8 ftco-animate text-center">
                ...
                <h1 class="mb-5 bread">Food Tech</h1>
            </div>
        </div>
    </div>
</section>
		      ...
		      <div class="row">
		        <div class="col-md-4 mb-3 text-center ftco-animate">
		          <div class="pricing p-4 py-5">
		            <h3 class="mb-3">DLAB</h3>
                    <img src="images/dlab_logo.png" alt="" class="img-fluid">

                    <div class="p-4">
                        <p><a href="http://www.dlabsci.com/english/index.htm" class="btn btn-primary px-4 py-3">More detail click here</a></p>
                    </div>
		          </div>
                </div>
