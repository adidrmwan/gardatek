		      ...
		      <div class="row">
		        <div class="col-md-4 mb-3 text-center ftco-animate">
		          <div class="pricing p-4 py-5">
		            <h3 class="mb-3">FuelCon</h3>
                    <img src="images/fuelcon_logo.png" alt="" class="img-fluid">

                    <div class="p-4">
                        <p><a href="http://fuelcon.com" class="btn btn-primary px-4 py-3">More detail click here</a></p>
                    </div>
		          </div>
                </div>
